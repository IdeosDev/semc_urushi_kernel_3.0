...
{ 1, 184320, PLL_3, 5, 4, 61440000, 775, VDD_RAW(775) },
{ 1, 245760, PLL_3, 5, 2, 61440000, 800, VDD_RAW(800) },
{ 1, 368640, PLL_3, 5, 1, 122800000, 825, VDD_RAW(825) },
{ 1, 460800, PLL_1, 2, 0, 153600000, 875, VDD_RAW(875) },
{ 0, 576000, PLL_1, 2, 0, 153600000, 875, VDD_RAW(875) },
{ 1, 652800, PLL_1, 2, 0, 153600000, 900, VDD_RAW(900) },
...
{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[3]},
{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[4]},
{ 1, 1305600, PLL_2, 3, 0, UINT_MAX, 1125, VDD_RAW(1125), &pll2_tbl[5]},
{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1175, VDD_RAW(1175), &pll2_tbl[6]},
{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[7]},
{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[8]},
{ 0 }
};
